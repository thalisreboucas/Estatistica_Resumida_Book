...
A estatística de teste, denotada por $W$, é dada pelo mínimo de $U_m$ e $U_n$ $ \begin{align*}
...
$ U_m = S_m - \dfrac{1}{2}m(m+1) ;$ \text{e} $; U_n = S_n - \dfrac{1}{2}n(n+1)$
...
Seu valor-p será dado por: $ 2P(W\>W\_{obs}-1,$\text{ se $W_{obs}>\dfrac{mn}{2}$ ou  $2P(W<W_{obs})$, se $W_{obs}\leq \dfrac{mn}{2} $ 
